...
\begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{img/10-schem}
...
\par En approximation av en bode-plot för kretsen finns i Figur \ref{fig:10-graf}.
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{img/10-graf}
    \caption[Uppskattad frekvensrespons för RLC-filter]
    {Uppskattad frekvensrespons för RLC-filter}
    \label{fig:10-graf}
\end{figure}
