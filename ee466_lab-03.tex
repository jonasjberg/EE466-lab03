...
% ==============================================================================
För att generera en växelspänning används signalgeneratorn HP33120A, vars utgång
kopplas till en BNC T-koppling, som förgrenar signalen till både multimetern HP34401A
och oscilloskopet. En adapter används för att ansluta BNC T-kopplingen till
vanliga "banan" labsladdar som kopplas till multimetern.
\par Multimetern ställs för att mäta $V_{AC}$ RMS med automatisk inställning
av mätområde. På oscilloskopet används funktioner under \emph{measure} för att
direkt visa signalens amplitud i $V_{pp}$. 
