...
När värdet hos $R_{3}$ sänks börjar spänningen vid tvåpolens utgång också att sjunka.
\par Halva tomgångsspänningen $\frac{V_{AB}}{2} = \unit[3.58]{\si{\volt}}$ avläses
vid en last av $R_{3}$ = \unit[341]{\si{\ohm}}. 
Strömmen genom lasten är då $I = \unit[10.531]{\si{\mA}}$.
...
Vid en resistans på t.ex. \unit[1]{\si{\Mohm}} blir felvärdet enligt Ekvation \ref{eq:err2}.
\par Ett felvärde på 0,09\% är utgör ett signifikant mätfel. I det här fallet
är lastresistansen som effektivt parallellkopplas med multimetern mycket lägre än
\unit[1]{\si{\Mohm}} och mätfelet blir inte fullt så allvarligt.
...
% ------------------------------------------------------------------------------
Kretsen som levererar spänningen ritas om till den i Figur \ref{fig:5-thevenin-schem}.
...
Den obelastade "tomgångsspänningen" mellan punkterna A och B, $V_{AB}$ beräknas enligt
Ekv. \ref{eq:thev1}.
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\linewidth]{img/5-thevenin-schem-2}
    \caption[Beräkning av Théveninekvivalens]
    {Kortsluten spänningskälla för att hitta inre resistans}
    \label{fig:5-thevenin-schem2}
\end{figure}

Den inre resistansen
är parallellkopplingen av $R_{1}$ och $R_{2}$ och beräknas enligt 
